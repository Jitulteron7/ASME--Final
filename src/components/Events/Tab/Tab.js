...
// Iam3d
import img1 from "./img/3d1.jpg";
import img2 from "./img/3d2.jpg";
import img3 from "./img/3d3.jpg";
// plan

import img4 from "./img/3d1.jpg";
import img5 from "./img/3d2.jpg";
import img6 from "./img/3d3.jpg";
    ...
    Presently, team Tejas 6.0 have taken part in E-fest Digital 2021 due to the Covid scenario and the results are awaited.
      ...
      <TabPanel>
        <Tabpanel
          ...
          contentP="
            The ASME Innovative Additive Manufacturing 3D (IAM3D) Challenge is designed to give mechanical and multi-disciplinary undergraduate students around the world, an opportunity to re-engineer existing products or create new designs. Students competing in IAM3D showcase their creativity by demonstrating the value added through their ingenuity, application of sound engineering design principles, and leveraging Additive Manufacturing technologies.
...
"
      ...
      <TabPanel>
        <Tabpanel
          ...
          SDC 2020 – MAKING THE DIFFERENCE
          The NITS SDC 2020 team not only bring experiences for themselves but also achievements for the college. The 2020 team had to build a bot that could make a paper tower from maximum 100 A4 sized papers. 
